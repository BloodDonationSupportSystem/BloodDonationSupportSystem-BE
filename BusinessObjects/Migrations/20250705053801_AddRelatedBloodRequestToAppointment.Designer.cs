...
namespace BusinessObjects.Migrations
{
    ...
    [Migration("20250705053801_AddRelatedBloodRequestToAppointment")]
    partial class AddRelatedBloodRequestToAppointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObjects.Models.BloodRequest", b =>
                {
                    ...
                    b.Property<Guid?>("FulfilledByStaffId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BloodGroupId", "ComponentTypeId", "Status", "IsEmergency");
            ...
            modelBuilder.Entity("BusinessObjects.Models.DonationAppointmentRequest", b =>
                {
                    ...
                    b.Property<Guid?>("RelatedBloodRequestId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RelatedBloodRequestId");
            ...
            modelBuilder.Entity("BusinessObjects.Models.BloodInventory", b =>
                {
                    ...
                    b.HasOne("BusinessObjects.Models.BloodRequest", "FulfilledRequest")
                        .WithMany()
                        .HasForeignKey("FulfilledRequestId");
            ...
            modelBuilder.Entity("BusinessObjects.Models.DonationAppointmentRequest", b =>
                {
                    ...
                    b.HasOne("BusinessObjects.Models.BloodRequest", "RelatedBloodRequest")
                        .WithMany()
                        .HasForeignKey("RelatedBloodRequestId")
                    ...
                    b.Navigation("RelatedBloodRequest");
